...
enum class FieldDestinations2021(name: String, destX: Float, destY: Float, clearanceRadius: Float) {
    ...
    BlueWarehouse("Alliance Warehouse (Blue)", 1219.2F, 1676.4F, 1328.6F),
    RedWarehouse("Alliance Warehouse (Red)", 1219.2F, -1676.4F, 1328.6F),
    BlueStart1("Blue Starting Location 1", 304.8F, 1676.4F, 1328.6F),
    RedStart1("Red Starting Location 1", 304.8F, -1676.4F, 1328.6F),
    BlueStart2("Blue Starting Location 2", -914.4F, 1676.4F, 1328.6F),
    RedStart2("Red Starting Location 2", -914.4F, -1676.4F, 1328.6F),
    BlueStorage("Blue Storage Unit", -1524F, 914.4F, 1328.6F),
    RedStorage("Red Storage Unit", -1524F, -914.4F, 1328.6F),
    BlueCarousel("Blue Carousel", -1828.8F, 1828.8F, 1709.6F),
    RedCarousel("Red Carousel", -1828.8F, -1828.8F, 1709.6F),
