...
//            return if (this.javaClass.interfaces.contains(DashOpMode::class.java)) MultipleTelemetry(opMode.telemetry, DashOpMode.Static.telemetry)
...
//        }
    ...
    open fun telemetry() { telemetry.addLine('\n' + name) }
}