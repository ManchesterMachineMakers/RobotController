...
fun MecDriveBase.runGrid(strafe: Double, fwb: Double, yaw: Double) {
    val y = strafe
    val x = fwb
    ...
    val (_, _, _, leftFront, rightFront, leftRear, rightRear) = MecDriveBase.MoveRobotCalculations(xTicks, yTicks, yawTicks)
...
fun MecDriveBase.runGrid(path: GridPath) {
